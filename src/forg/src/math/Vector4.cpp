...
float Vector4::operator*(const Vector4& value) const { return Dot(value); }
...
void Vector4::Scale(float fScale) { *this *= fScale; }
...
Vector4& Vector4::TransformCoordinate(Vector4& vOut, const Vector4& vSource,
                                      const Matrix4& mTransformation)
{
    Vector4 v(
        vSource.X * mTransformation.M11 + vSource.Y * mTransformation.M21 +
            vSource.Z * mTransformation.M31 + vSource.W * mTransformation.M41,
        vSource.X * mTransformation.M12 + vSource.Y * mTransformation.M22 +
            vSource.Z * mTransformation.M32 + vSource.W * mTransformation.M42,
        vSource.X * mTransformation.M13 + vSource.Y * mTransformation.M23 +
            vSource.Z * mTransformation.M33 + vSource.W * mTransformation.M43,
        vSource.X * mTransformation.M14 + vSource.Y * mTransformation.M24 +
            vSource.Z * mTransformation.M34 + vSource.W * mTransformation.M44);

    return (vOut = v);
}

Vector4& Vector4::CatmullRom(Vector4& vOut, const Vector4& v0,
