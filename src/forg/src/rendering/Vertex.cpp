...
PositionTextured::PositionTextured(float xvalue, float yvalue, float zvalue,
                                   float u, float v)
{
    this->X = xvalue;
    this->Y = yvalue;
...
PositionColored::PositionColored(float xvalue, float yvalue, float zvalue,
                                 int c)
{
    this->X = xvalue;
    this->Y = yvalue;
...
void PositionColored::set_Color(int iColor) { this->Color = iColor; }
/************************************************************************/
...
/*
PositionColoredTextured::PositionColoredTextured(const Vector3& value, int c,
float u, float v)
{
        this->X = value.X;
        this->Y = value.Y;
...
PositionColoredTextured::PositionColoredTextured(float xvalue, float yvalue,
float zvalue, int c, float u, float v)
{
        this->X = xvalue;
        this->Y = yvalue;
        this->Z = zvalue;
...
PositionNormal::PositionNormal(float xvalue, float yvalue, float zvalue,
                               float nxvalue, float nyvalue, float nzvalue)
{
    Position.X = xvalue;
    Position.Y = yvalue;
    Position.Z = zvalue;
...
PositionNormalTextured::PositionNormalTextured(const Vector3& pos,
                                               const Vector3& nor, float u,
                                               float v)
{
    Position = pos;
    Normal = nor;
...
PositionNormalTextured::PositionNormalTextured(float xvalue, float yvalue,
                                               float zvalue, float nxvalue,
                                               float nyvalue, float nzvalue,
                                               float u, float v)
{
    Position.X = xvalue;
    Position.Y = yvalue;
