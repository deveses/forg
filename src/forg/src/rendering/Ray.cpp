...
// Intersection" R(t) = O + tD O = ray's origin, D = normalized direction T(u,v)
// = (1 - u - v)V0 + uV1 + vV2 (u,v) - barycentric coordinates where u,v >=0 and
// u+v<=1 we need to resolve R(t) = T(u,v) => O + tD = (1 - u - v)V0 + uV1 + vV2
...
bool Ray::TriangleIntersection(const Vector3& vert0, const Vector3& vert1,
                               const Vector3& vert2, float epsilon,
                               bool culling, float& t, float& u, float& v) const
{
