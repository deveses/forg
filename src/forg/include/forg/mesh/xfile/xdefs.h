...
template <class _Type> class PrimitiveArray
{
  public:
  ...
  public:
    PrimitiveArray() : m_data(0), m_size(0), m_capacity(0) {}

    PrimitiveArray(size_type _count) : m_data(0), m_size(0), m_capacity(0)
    {
        reserve(_count);
        m_size = _count;
    }

    ~PrimitiveArray() { destroy(); }
  ...
  public:
    ...
    void copy_to(PrimitiveArray& _right, iterator _begin, iterator _end,
                 iterator _where)
    {
