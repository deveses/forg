...
template <class _Type> class vector
{
  public:
    ...
    class iterator
    {
      public:
        ...
        iterator(_Type* _ptr) { m_ptr = _ptr; }
    ...
    class const_iterator
    {
      public:
        ...
        const_iterator(_Type* _ptr) { m_ptr = _ptr; }
  ...
  public:
    ...
    vector(size_type _count) : m_data(0), m_size(0), m_capacity(0)
    {
        reserve(_count);
        m_size = _count;
    }
  ...
  public:
    ...
    reference front() { return ((_Type*)m_data)[0]; }

    reference back() { return ((_Type*)m_data)[m_size - 1]; }

    iterator begin() { return iterator((_Type*)m_data); }

    const_iterator begin() const { return const_iterator((_Type*)m_data); }

    iterator end() { return iterator(((_Type*)m_data) + m_size); }
    ...
    void copy_to(vector& _right, iterator _begin, iterator _end,
                 iterator _where)
    {
