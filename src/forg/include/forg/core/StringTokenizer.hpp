...
template <typename T = char> class StringTokenizer
{
    //////////////////////////////////////////////////////////////////////
    // Nested
    //////////////////////////////////////////////////////////////////////
  ...
  public:
    ...
    StringTokenizer(const string_type& str)
        : m_string(str), m_nLastPos(0), m_bReturnDelims(false)
    {
    }
    ...
    /**
     * Constructs a string tokenizer for the specified string.
     * The characters in the delim argument are the delimiters for separating
    ...
    StringTokenizer(const string_type& str, const string_type& delim)
        : m_string(str), m_delim(delim), m_nLastPos(0), m_bReturnDelims(false)
    {
    }
    ...
    /**
     * Constructs a string tokenizer for the specified string.
     * All characters in the delim argument are the delimiters for separating
     * tokens. If the returnDelims flag is true, then the delimiter characters
     * are also returned as tokens. Each delimiter is returned as a string of
    ...
    StringTokenizer(const string_type& str, const string_type& delim,
                    bool returnDelims)
        : m_string(str), m_delim(delim), m_nLastPos(0),
  ...
  public:
     ...
     * Tests if there are more tokens available from this tokenizer's string.
     * @return
     * true if and only if there is at least one token in the string after the
     * current position; false otherwise.
     */
    bool HasMoreTokens() { return m_nLastPos < m_string.size(); }
     ...
     * StringTokenizer object is changed to be the characters in the string
     * delim. Then the next token in the string after the current position is
