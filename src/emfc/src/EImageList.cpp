...
EImageList::EImageList() { m_hImageList = NULL; }
...
BOOL EImageList::RemoveAll() { return ImageList_RemoveAll(m_hImageList); }
...
BOOL EImageList::Destroy() { return ImageList_Destroy(m_hImageList); }
