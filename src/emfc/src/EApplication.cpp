...
EApplication::EApplication() { m_hInstance = GetModuleHandle(NULL); }
...
DWORD EApplication::Create(HWND hWnd) { return 0; }
...
BOOL EApplication::InitApplication() { return TRUE; }
...
BOOL EApplication::OnIdle(LONG lCount) { return FALSE; }
...
int EApplication::ExitInstance() { return m_msgCur.wParam; }
...
BOOL EApplication::PreTranslateMessage(MSG* pMsg) { return FALSE; }
