...
{
    static INT_PTR CALLBACK EDialogProc(HWND hwndDlg, UINT uMsg, WPARAM wParam,
                                        LPARAM lParam);

  public:
    BOOL OnCommand(WPARAM wParam, LPARAM lParam);
    BOOL CreateIndirect(LPCDLGTEMPLATE lpDialogTemplate, HWND pParentWnd,
                        HINSTANCE hInst);
    ...
    BOOL CreateIndirect(HGLOBAL hDialogTemplate, HWND pParentWnd,
                        HINSTANCE hInst);
