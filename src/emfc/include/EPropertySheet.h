...
#if !defined(                                                                  \
    AFX_EPROPERTYSHEET_H__C1E98EC7_C987_4F34_9B7C_9258D326DDF5__INCLUDED_)
...
class EMFC_API EPropertySheet : public EWnd
{
  public:
    ...
    void Construct(LPCTSTR pszCaption, HWND pParentWnd = NULL,
                   UINT iSelectPage = 0);
    EPropertySheet(LPCTSTR pszCaption, HWND pParentWnd = NULL,
                   UINT iSelectPage = 0);
    EPropertySheet();
