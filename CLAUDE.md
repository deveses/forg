...
On Windows, CMake also builds `glrenderer`, the GDI side of `swrenderer`, `emfc`, and `winapp`. OpenCL and C++ AMP remain outside the canonical build; the Sharpmake-generated projects are retained temporarily for parity checks.
